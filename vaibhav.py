...
bot = telebot.TeleBot('7209930698:AAFiHfkT49lbE9ej8HzBx7no1YpYwNcRnHo')

# Admin user IDs
admin_id = ["2136214036","7058106118"]
...
def welcome_start(message):
    ...
    response = (
        f"🥀Welcome {user_name}!\n\n"
        " For User ID : /id \n\n"
        "👉 Join our official channel -https://t.me/BOOMBAMALLCHEAT3344  ✅\n\n"
        "👑 For access: @Broken_heart_41"
        "👑 OWNER : @Broken_heart_41"
    )
    bot.reply_to(message, response)
...
def clear_logs_handler(message):
    ...
    if user_id in admin_id:
        ...
        bot.reply_to(message, "Only @Broken_heart_41 can run this command.")
